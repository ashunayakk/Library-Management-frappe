...
def get_columns():
	return [{'label': 'Member Name', 'fieldname': 'member_name', 'fieldtype': 'Data', 'width': 150}, {'label': 'Email', 'fieldname': 'email', 'fieldtype': 'Data', 'width': 180}, {'label': 'Phone', 'fieldname': 'phone', 'fieldtype': 'Data', 'width': 120}, {'label': 'To Date', 'fieldname': 'to_date', 'fieldtype': 'Date', 'width': 100}, {'label': 'Days Remaining', 'fieldname': 'days_remaining', 'fieldtype': 'Int', 'width': 120}]
